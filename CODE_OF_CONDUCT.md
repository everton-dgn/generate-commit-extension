...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via [GitHub Security Advisories](https://github.com/everton-dgn/generate-commit-extension/security/advisories/new) ou por contato direto com o mantenedor. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
